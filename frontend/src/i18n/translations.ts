...
export const translations = {
  es: {
    ...
    auth: {
      ...
      weakPassword: "La contraseña debe tener mínimo 8 caracteres y al menos un número",
      passwordMismatch: "Las contraseñas no coinciden",
      forgotDesc: "Introduce tu dirección de email y te enviaremos un enlace para restablecer la contraseña.",
      sendLinkBtn: "Enviar enlace",
      sending: "Enviando...",
      forgotSent: "Revisa tu correo — te hemos enviado el enlace de restablecimiento.",
    ...
    admin: {
      ...
      profile: {
        ...
        emailChangeSent: "Revisa tu correo — enviamos el enlace de confirmación.",
  ...
  en: {
    ...
    auth: {
      ...
      weakPassword: "Password must be at least 8 characters and contain at least one digit",
  ...
  uk: {
    ...
    auth: {
      ...
      weakPassword: "Пароль має бути мінімум 8 символів та містити хоча б одну цифру",
      passwordMismatch: "Паролі не збігаються",
      forgotDesc: "Введіть email адресу, і ми надішлемо посилання для відновлення пароля.",
      sendLinkBtn: "Надіслати посилання",
      sending: "Надсилаємо...",
      forgotSent: "Перевірте пошту — ми надіслали посилання для відновлення пароля.",
